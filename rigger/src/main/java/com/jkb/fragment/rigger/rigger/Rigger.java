...
public final class Rigger {
    ...
    public static IRigger getRigger(Object puppet) {
        ...
        if (!(puppet instanceof AppCompatActivity) && !(puppet instanceof Fragment)) {
            throw new RiggerException(
                "Puppet Annotation class can only used on androidx.appcompat.app.Activity or androidx.fragment.app.Fragment");
        }
        //filter the unsupported class
     ...
     * /{@link Fragment#onCreate(Bundle)} to rigger class.
     *
    ...
    /**
     * Inject the Activity's lifecycle method  to rigger class.
     */
    ...
    /**
     * Inject the AppCompatActivity's lifecycle method  to rigger class.
     */
    ...
    /**
     * Inject the Activity/Fragment's lifecycle method
     *  ()} ()}/{@link Fragment#onDestroy()} to rigger class.
     */
